...
\title{Pemecah Sudoku Interaktif Berbasis Python}\let\Title\@title   %Judul dalam bahasa Indonesia

\newcommand{\EngTitle}{A Python-Based Interactive Sudoku Solver.}  %Judul dalam bahasa Inggris
...
\newcommand{\Tanggal}{28} % Tanggal Pengesahan
